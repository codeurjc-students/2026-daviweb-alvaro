...
- **Sincronía de versión:** `package.json` (front y back) ↔ tag de `docker-compose.yml` ↔ **tag git**. Evitar duplicar
  lógica entre jobs. Publicar en **DockerHub** (cuenta del alumno).
