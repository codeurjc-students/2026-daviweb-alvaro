# docs/tfg — Base de conocimiento del TFG

Verdad única que leen los modos del asistente (ver `CLAUDE.md` en la raíz). **Lee bajo demanda**, no todo de golpe.

| Fichero | Para qué | Lo usa sobre todo |
|---|---|---|
...
| [`seguimiento.md`](seguimiento.md) | Fases, horas, riesgos, decisiones, blog | Asesor / Redacción |
| [`glosario.md`](glosario.md) | Términos ES/EN consistentes | Ingeniero / Redacción |

**Regla de oro:** al terminar una sesión con avances, actualiza `estado-vs-rubrica.md` y `seguimiento.md`.
